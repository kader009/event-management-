  ...
  return (
    <Container>
      <div className="flex justify-between items-center flex-wrap gap-[35px] sm:justify-center md:justify-center lg:justify-between sm:mt-[180px] lg:mt-[0px]">
        <div>
          <h1 className='text-[#061C3D] text-[56px] font-extrabold mb-[24px]'>Upcoming Events</h1>
          ...
          <div className='w-[536px] bg-[#FFF9EE] rounded-lg p-[32px] mt-[48px]'>
            <div className="flex gap-[20px]">
              ...
              <div>
                <h1 className='text-[#061C3D] text-[20px] font-medium'>Golf Clubbers Annual Agenda</h1>
            ...
            <div className="flex gap-[20px]">
              ...
              <div>
                <h1 className='text-[#061C3D] text-[20px] font-medium'>Music Events at LA</h1>
                <p className='text-[#42526B] text-[16px]'>
        ...
        <div className='mt-[96px]'>
          <p className='text-center text-[20px]'>We have <span className='text-[#0B63E5]'>23k+</span>  Satisfied & Trusted Customers</p>
